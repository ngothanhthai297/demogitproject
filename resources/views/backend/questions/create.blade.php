  ...
  <div class="card-body">
    <form method="post" action="{{route('questions.store')}}">
      ...
      <div class="form-group">
        ...
        <input id="inputTitle" type="text" name="question_name" placeholder="Enter title" value="{{old('tilte')}}" class="form-control">
        @error('title')
      ...
      <div class="form-group">
        ...
        <input id="inputName" type="text" name="question_content" placeholder="Enter title" class="form-control">
        @error('name')
        <span class="text-danger">{{$message}}</span>
        @enderror
      </div>
