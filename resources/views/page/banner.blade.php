                                    ...
                                    <div class="col-lg-6 col-md-12">
                                        <div class="banner-content pt-5">
                                            <h1 class="best-template animated" data-animation="fadeInUpShorter"
                                                data-animation-delay="1.5s">{{$banners->title}}</h1>
                                            <h3 class="d-block white animated" data-animation="fadeInUpShorter"
                                                data-animation-delay="1.6s">{!!$banners->content!!}</h3>
                                            <div class="mt-5">
                                                ...
                                                <a href="https://docs.vechain.org/thor/learn/" target="_blank"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 857 807" width="857"
                                                ...
                                                <g clip-path="url(#svg_animation_mask)">
                                                    ...
                                                    <g transform="matrix(1,0,0,1,-1.93,468.7)" opacity="1">
                                                        <image class="animated" data-animation="fadeInLeftShorter"
                                                            data-animation-delay="1s" width="558px" height="339px"
                                                            preserveAspectRatio="xMidYMid slice"
                                                            xlink:href="theme-assets/images/svg/svg-animation/base.svg">
                                                        </image>
                                                    </g>

                                                    <!-- btc-base-shadow -->
                                                    <g transform="matrix(1,0,0,1,60,580)" opacity="0.8">
                                                        <image class="animated" data-animation="fadeInUpShorter"
                                                            data-animation-delay="2s" width="130px" height="130px"
                                                            preserveAspectRatio="xMidYMid slice"
                                                            xlink:href="theme-assets/images/svg/svg-animation/icon-base-shadow.svg">
                                                        </image>
                                                    </g>
                                                    ...
                                                    <g transform="matrix(1,0,0,1,60.8,560.9)" opacity="1">
                                                        <image class="animated" data-animation="fadeInUpShorter"
                                                            ...
                                                            preserveAspectRatio="xMidYMid slice"
                                                            xlink:href="theme-assets/images/svg/svg-animation/icon-base-btc.svg">
                                                        </image>
                                                    </g>
                                                    ...
                                                    <g transform="matrix(1,0,0,1,215,545)" opacity="1">
                                                        <image class="animated" data-animation="fadeInUpShorter"
                                                            ...
                                                            preserveAspectRatio="xMidYMid slice"
                                                            xlink:href="theme-assets/images/svg/svg-animation/icon-base-eth.svg">
                                                        </image>
                                                    </g>
                                                    ...
                                                    <g transform="matrix(1,0,0,1,240.8,660.9)" opacity="1">
                                                        <image class="animated" data-animation="fadeInUpShorter"
                                                            ...
                                                            preserveAspectRatio="xMidYMid slice"
                                                            xlink:href="theme-assets/images/svg/svg-animation/icon-base-neo.svg">
                                                        </image>
                                                    </g>

                                                    <!-- btc -->
                                                    <g transform="matrix(1,0,0,1,97,560)" opacity="1">
                                                        <image class="animated svg-elements-2"
                                                            data-animation="fadeInUpShorter" data-animation-delay="2s"
                                                            width="60px" height="60px"
                                                            preserveAspectRatio="xMidYMid slice"
                                                            xlink:href="theme-assets/images/svg/svg-animation/btc.svg">
                                                        </image>
                                                    </g>

                                                    <!-- eth -->
                                                    <g transform="matrix(1,0,0,1,230,550)" opacity="1">
                                                        <image class="animated svg-elements-1"
                                                            data-animation="fadeInUpShorter" data-animation-delay="1.6s"
                                                            width="60px" height="60px"
                                                            preserveAspectRatio="xMidYMid slice"
                                                            xlink:href="theme-assets/images/svg/svg-animation/eth.svg">
                                                        </image>
                                                    </g>
                                                    ...
                                                    <g transform="matrix(1,0,0,1,270 ,645)" opacity="1">
                                                        <image class="animated svg-elements-1"
                                                            ...
                                                            preserveAspectRatio="xMidYMid slice"
                                                            xlink:href="theme-assets/images/svg/svg-animation/neo.svg">
                                                        </image>
                                                    </g>
                                                    ...
                                                    <g transform="matrix(1,0,0,1,152.1,445.61)" opacity="0.8">
                                                        <image class="animated" data-animation="fadeInLeftShorter"
                                                            ...
                                                            preserveAspectRatio="xMidYMid slice"
                                                            xlink:href="theme-assets/images/svg/svg-animation/base-shadow.svg">
                                                        </image>
                                                    </g>
                                                    <!-- base -->
                                                    ...
                                                    <g transform="matrix(1,0,0,1,428.5,403.5)" opacity="1">
                                                        <g opacity="1"
                                                            ...
                                                            <path class="animated" data-animation="path"
                                                    ...
                                                    <g transform="matrix(1,0,0,1,345,595)" opacity="1">
                                                        <g opacity="1" transform="matrix(1,0,0,1,0,0)">
                                                            <path class="animated" data-animation="path-reverse"
                                        ...
                                        <image class="animated" data-animation="fadeInLeftShorter" data-animation-delay="1.4s" width="250px" height="260px" preserveAspectRatio="xMidYMid slice" xlink:href="theme-assets/images/svg/svg-animation/logo-base.svg"></image>
                                                    ...
                                                    <g transform="matrix(0.1385,0,0,0.1175,275,385)" opacity="0.65">
                                                        <image class="animated" data-animation="fadeInUpShorter"
                                                            ...
                                                            preserveAspectRatio="xMidYMid slice"
                                                            xlink:href="theme-assets/images/svg/svg-animation/logo-shadow.svg">
                                                        </image>
                                                    </g>
                                                    <!-- logo -->
                                                    <g transform="matrix(1,0,0,1,310,410)" opacity="1">
                                                        <image class="animated cic-logo"
                                                            data-animation="fadeInUpShortest"
                                                            data-animation-delay="2.4s" width="130px" height="89px"
                                                            preserveAspectRatio="xMidYMid slice"
                                                            xlink:href="theme-assets/images/IMT_Logo_New-03.1.png">
                                                        </image>
                                                    </g>
                                                    ...
                                                    <g transform="matrix(1,0,0,1,408.62,240.74)" opacity="1">
                                                        <image class="animated" data-animation="fadeInUpShorter"
                                                            ...
                                                            preserveAspectRatio="xMidYMid slice"
                                                            xlink:href="theme-assets/images/svg/svg-animation/icon-base-car.svg">
                                                        </image>
                                                    </g>
                                                    ...
                                                    <g transform="matrix(1,0,0,1,420.8799,200.27)" opacity="1">
                                                        <image class="animated svg-elements-1"
                                                            ...
                                                            preserveAspectRatio="xMidYMid slice"
                                                            xlink:href="theme-assets/images/svg/svg-animation/car.svg">
                                                        </image>
                                                    </g>
                                                    ...
                                                    <g transform="matrix(1,0,0,1,565,310)" opacity="1">
                                                        <image class="animated" data-animation="fadeInUpShorter"
                                                            ...
                                                            preserveAspectRatio="xMidYMid slice"
                                                            xlink:href="theme-assets/images/svg/svg-animation/icon-base-mobile.svg">
                                                        </image>
                                                    </g>
                                                    ...
                                                    <g transform="matrix(1,0,0,1,600,280)" opacity="1">
                                                        <image class="animated svg-elements-1"
                                                            ...
                                                            preserveAspectRatio="xMidYMid slice"
                                                            xlink:href="theme-assets/images/svg/svg-animation/mobile.svg">
                                                        </image>
                                                    </g>
                                                    ...
                                                    <g transform="matrix(1,0,0,1,570.8,140.9)" opacity="1">
                                                        <image class="animated" data-animation="fadeInUpShorter"
                                                            ...
                                                            preserveAspectRatio="xMidYMid slice"
                                                            xlink:href="theme-assets/images/svg/svg-animation/icon-base-home.svg">
                                                        </image>
                                                    </g>
                                                    <!-- home -->
                                                    <g transform="matrix(1,0,0,1,600,90)" opacity="1">
                                                        <image class="animated svg-elements-2"
                                                            ...
                                                            class="svg-elements-2" width="140px" height="140px"
                                                            preserveAspectRatio="xMidYMid slice"
                                                            xlink:href="theme-assets/images/svg/svg-animation/home.svg">
                                                        </image>
                                                    </g>
                                                    ...
                                                    <g transform="matrix(1,0,0,1,734,400)" opacity="0.8">
                                                        <image class="animated" data-animation="fadeInLeftShorter"
                                                            ...
                                                            preserveAspectRatio="xMidYMid slice"
                                                            xlink:href="theme-assets/images/svg/svg-animation/physical.svg">
                                                        </image>
                                                    </g>
                                                    <!-- step-2-text -->
                                                    <g transform="matrix(1,0,0,1,602,569)" opacity="0.8">
                                                        <image class="animated" data-animation="fadeInLeftShorter"
                                                            ...
                                                            preserveAspectRatio="xMidYMid slice"
                                                            xlink:href="theme-assets/images/svg/svg-animation/cic-blockchain.svg">
                                                        </image>
                                                    </g>
                                                    <!-- step-3-text -->
                                                    <g transform="matrix(1,0,0,1,432,745)" opacity="0.8">
                                                        <image class="animated" data-animation="fadeInLeftShorter"
                                                            ...
                                                            preserveAspectRatio="xMidYMid slice"
                                                            xlink:href="theme-assets/images/svg/svg-animation/digital.svg">
                                                        </image>
                                                    </g>
                                                </g>
                                                <defs>
